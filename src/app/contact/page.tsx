...
export default function ContactPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 md:px-6 pt-10 md:pt-12 pb-16">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-[var(--fg)]">
          Contacto
        </h1>
      ...
      <section className="flex justify-center">
        <motion.form
          ...
          className="w-full max-w-3xl card shadow-brand rounded-2xl p-6 sm:p-8"
        >
          {/* Nombre */}
          <label className="block text-sm font-medium text-[var(--fg)]">
            ...
            <input
              ...
              className="mt-1 w-full rounded-xl border-s bg-[var(--surface)] px-3 py-2
                         text-[var(--fg)] placeholder:text-muted/70 outline-none
                         transition-colors
